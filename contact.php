...
<div class="landing_page">
  <div class="responsive-container-block big-container">
    <img class="bg-img" id="iq5bf" src="img/bg.jpg">
      ...
      <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12 left-one">
        <div class="content-box">
          ...
          <p class="text-blk section-subhead">
            Your trusted partner in healthcare solutions. We are here to provide you with the best medical services and support.
          </p>
           ...
           Contact Us
            ...
            <div class="responsive-container-block">
              <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i10mt-7">
                <input class="input" id="first_name" name="FirstName" placeholder="First Name">
              </div>
              <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i1ro7">
                <input class="input" id="last_name" name="Last Name" placeholder="Last Name">
              </div>
              ...
              <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
                <input class="input" id="phone_number" name="PhoneNumber" placeholder="Phone Number">
              </div>
              <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="message">
...
.landing_page .input {
  ...
  color: white;
  border: 1px solid rgba(255, 255, 255, 0.3); /* Border for inputs */
  padding: 1px 12.5px 1px 22.5px;
}

.landing_page .input::placeholder, .landing_page .textinput::placeholder {
